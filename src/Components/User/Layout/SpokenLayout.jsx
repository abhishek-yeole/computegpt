            ...
            <div className='layout-body'>
                ...
                <div className='other-functions'>
                    ...
                    <div className='function-2'>
                        <Link to={'../user'} style={{textDecoration: 'none', color:'black', width:'100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>STEPS</Link>
                    </div>
